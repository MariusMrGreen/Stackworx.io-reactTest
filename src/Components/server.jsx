    ...
    render() { 
        this.interval = setInterval(() => {
            ...
            if(this.state.healthyTime != null) {
                this.setState({
                    seconds : Math.round( (new Date().getTime() - new Date( this.state.healthyTime).getTime()) / 1000)
                })
            ...
            ReactDOM.render(timerElement, document.getElementById('server-' + this.state.serverId));
        }, 1000);
        ...
        return ( 
            <div className={classes} onClick={this.handleShow} style={this.style}>
                ...
                <div className="card-body">
                    ...
                    <div id={'server-' + this.state.serverId}>
                    </div>
                    <p>Show/hide info</p>
